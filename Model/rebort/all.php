...
<table id="example" class="display text-center" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <?php
                if ($op['op_type']==1 || $op['op_type']==7  || $op['op_type']==13 || $op['op_type']==8 ||$op['op_type']==4) {
                    echo get_name_by_id("tree4", "tree4_code", $op['op_tree_code_out'], "tree4_name");
                } elseif ($op['op_type']==2 ||$op['op_type']==3 || $op['op_type']==14 ||$op['op_type']== 6) {
        ...
        if ($op['op_type']==1 || $op['op_type']==7  || $op['op_type']==13 || $op['op_type']==8 ||$op['op_type']==3) {
            ...
            //echo get_name_by_id("items","it_id",$op['it_code'],"it_name");?> </td>
            <td> <?php echo $op['op_discont_out'];//echo get_name_by_id("items","it_id",$op['it_code'],"it_name");?>     </td>
            <td> <?php echo $op['op_discont'];//echo get_name_by_id("items","it_id",$op['it_code'],"it_name");?>     </td>
            <!-- <td><?php
                        if ($op['op_type']==1 || $op['op_type']==7  || $op['op_type']==13 || $op['op_type']==8 ||$op['op_type']==3) {
                            // echo $op['it_qty_in'];
                        } elseif ($op['op_type']==2 ||$op['op_type']==4 || $op['op_type']==14 ||$op['op_type']== 6) {
            ...
            <!-- <td> <?php
                if ($op['op_type']==1 || $op['op_type']==7  || $op['op_type']==13 || $op['op_type']==8 ||$op['op_type']==3) {
                    ...
                    //  echo $op['cash_out']- $op['op_discont'];
                }
