...
<div id="print_div">
    <!-- ################################################################# -->
<div class="row row_main main_cash" id="main_rebor_all">
...
<div class="row row_main main_cash">
    ...
    <span class="col-lg-3 col-md-10 col-sm-8 col-8" id="div_input1">
        ...
        <input id="before_all" class="inp_date" type="date" value="<?php echo  date('Y-m-d'); ?>">
    </span>
    <span class="col-lg-1 col-md-10 col-sm-8 col-8">
    ...
    <span class="col-lg-3 col-md-10 col-sm-8 col-8">
        ...
        <input id="after_all" class="inp_date" type="date" value="<?php echo  date('Y-m-d'); ?>">
    </span>
...
<div class="row row_main main_cash" id="this_tb">
    <div class="col-lg-1 col-md-2 col-sm-4 col-4 hide_on_sm"></div>
    
    <div class="col-lg-11 col-md-2 col-sm-4 col-4" id="tbrebort">
