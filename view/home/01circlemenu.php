                     ...
                     <div class="holderCircle">
                        ...
                        <div class="dotCircle">
                           <span class="itemDot active itemDot1" data-tab="1">
                             <img src="img/food/01.png" class="food_img" alt="food">
                             <span class="forActive"></span>

                           </span>
                           <span class="itemDot itemDot2" data-tab="2">
                           <img src="img/food/02.png" class="food_img" alt="food">
                           <span class="forActive"></span>
                           </span>
                           <span class="itemDot itemDot3" data-tab="3">
                           <img src="img/food/03.png" class="food_img" alt="food">
                           <span class="forActive"></span>
                           </span>
                           <span class="itemDot itemDot4" data-tab="4">
                           <img src="img/food/04.png" class="food_img" alt="food">
                           <span class="forActive"></span>
                           </span>
                           <span class="itemDot itemDot5" data-tab="5">
                           <img src="img/food/05.png" class="food_img" alt="food">
                           <span class="forActive"></span>
                           </span>
                           <span class="itemDot itemDot6" data-tab="6">
                           <img src="img/food/06.png" class="food_img" alt="food">
                           <span class="forActive"></span>
                           </span>
                        </div>
                        <div class="contentCircle">
                           <div class="CirItem title-box active CirItem1">
                           <img src="img/food/01.png" class="food_img_active" alt="food">
                              <!-- <h2 class="title"><span>Automate</span></h2> -->
                              <!-- <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p> -->
                              <!-- <i class="fa fa-clock-o"></i> -->
                           </div>
                           <div class="CirItem title-box CirItem2">
                           <img src="img/food/02.png" class="food_img_active" alt="food">
                           ...
                           <img src="img/food/03.png" class="food_img_active" alt="food">
                           ...
                           <img src="img/food/04.png" class="food_img_active" alt="food">
                           ...
                           <img src="img/food/05.png" class="food_img_active" alt="food">
                           ...
                           <img src="img/food/06.png" class="food_img_active" alt="food">
