...
<hr />
<div class="row row_main main_un" style="   width: 100%;    right: 10%; position: relative;">

    <div class="col-lg-4 col-md-10 col-sm-8 col-8">
        <h3 class="nav-link"> <i class="fa fa-list"></i> مراجعة الفواتير</h3>
    </div>
    <div class="col-lg-5 col-md-1 col-sm-1 col-1 hide_on_sm">
    </div>

    <div class="col-lg-3 col-md-2 col-sm-3 col-3 pull-ledft">
        <!-- <button class="btn btn-primary" id="btn_dd_un"> <i class="fa fa-plus"></i> إضافة وحـدة</button> -->
    </div>
</div>

<div class="row row_main" style=" width:100%;    right: 10%; position: relative;">
    <div class="col-lg-10 col-md-12 col-sm-12 col-12 " id="ordertbody">
